 ...
 * Home Page Component
 * 
 * This component serves as the landing page for Q-up, displaying key features,
 * benefits, and call-to-action elements to attract new users to the platform.
 * It showcases the platform's value proposition and directs visitors to register
 * or browse available players.
 * 
 * @module Home
...
import "../../styles/pages/info/Home.css";
import logo from "../../assets/qup-logo.svg";

/**
 * Home component - Landing page for the Q-up application
 * 
  ...
  const features = [
    {
      ...
      title: "Play Together",
      description: "Find players who share your schedule and game preferences."
    },
    {
    ...
    },
    {
      ...
      description: "Monitor your game achievements and ranking improvements."
    },
    {
    ...
    },
    {
      ...
      description: "Find players based on game, rank, and playing style."
    },
    {
      icon: <ScheduleIcon sx={{ fontSize: 40, color: theme.palette.primary.main }} />,
      title: "Flexible Scheduling",
      description: "Coordinate gaming sessions across different time zones."
    }
  ];
          ...
          <Card className="cta-card">
            <CardContent sx={{ textAlign: 'center', py: 6 }}>
              ...
              <Typography variant="h6" color="text.secondary" paragraph>
                Join thousands of gamers who find their perfect teammates every day.
              </Typography>
