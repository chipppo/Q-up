...
/**
 * Shows how strong a password is with a colored bar and checklist
 * 
 * @param {Object} props - Component props
 * @param {string} props.password - The password to evaluate
 * @returns {JSX.Element|null} The strength indicator UI or null if no password
 */
function PasswordStrengthIndicator({ password }) {
   ...
   * @returns {Object} Strength score (0-4), label, and color
   */
 ...
 * 
 * Handles the entire registration process including:
 * - Form input and validation
 * - API calls to create account
...
function Register() {
  ...
  /**
   * Validates the username field with specific rules
   * 
  ...
  /**
   * Validates the email field with standard email format
   * 
  ...
  /**
   * Checks if the confirmation password matches the original
   * 
   * @param {string} value - The confirmation password
   * @param {string} passwordValue - The original password to match against
   * @returns {string} Error message or empty string if valid
   */
   ...
   * Also validates confirm password to ensure they still match
   * 
   * @param {React.ChangeEvent} e - Input change event
   */
